      ...
      <div className="container" onClick={() => dispatch(handleNav(false))}>
        <div className="name">
          ...
          <h1 style={{ color: "#002057" }}>
            I&apos;m Aadish <span style={{ color: "orange" }}>Jain</span>
          </h1>
          <h1>
            I am into{" "}
            <span style={{ color: "darkred" }}>
              <Typewriter text="Web Development" delay={200} infinite />
            </span>
          </h1>
          ...
          <div>
            <ul className="social">
              <Link
                target="_blank"
                to={"https://www.linkedin.com/in/aadish-jain-815379244/"}
              >
                <li className="social-list">
                  <i className="fa-brands fa-linkedin"></i>
                </li>
              </Link>
              <Link to={"https://github.com/Aadish25"} target="_blank">
                <li className="social-list">
